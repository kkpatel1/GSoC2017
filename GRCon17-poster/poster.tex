...
\title{gr-bokehgui: A web based display \\for GNU Radio applications} % Poster title

\author{Kartik Patel} % Author(s)

\institute{Department of Electrical and Computer Engineering, University of Texas at Austin} % Institution(s)
